...
public class Lambda_01_Test {
    ...
    public void test_filter_by_age() throws Exception {
        ...
        PersonPredicate predicate = (Person p) -> p.getAge() >= 18;
    ...
    public void test_filter_by_firstname() throws Exception {
        ...
        PersonPredicate predicate = (Person p) -> p.getFirstname().equals("first_10");
    ...
    public void test_filter_by_password() throws Exception {
        ...
        PersonPredicate predicate = (Person p) -> p.getAge()>49 && DigestUtils.sha512Hex(p.getPassword()).equals(passwordSha512Hex);
